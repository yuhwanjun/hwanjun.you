...
export default function Home() {
  ...
  const handleToggleView = () => {
    const next: View = view === "list" ? "grid" : "list";
    setOpenId(null);
    setView(next);
  };
  ...
  return (
    <div className="min-h-svh w-full overflow-y-auto bg-black text-white">
      ...
      <button
        ...
        className="fixed left-6 top-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5 text-white/30 transition-colors hover:text-white/70">
        {view === "list" ? (
          <>
            ...
            <span className="text-[9px] tracking-wider uppercase">Grid</span>
          </>
        ) : (
          <>
            ...
            <span className="text-[9px] tracking-wider uppercase">List</span>
          </>
        )}
      </button>
    </div>
